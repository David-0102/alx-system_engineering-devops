...
Arguments:
    employee_id (int): The ID of the employee whose TODO list is to be checked.
...
4. Prints out the employee's name and their TODO list.
"""
...
def gather_data(employee_id):
    ...
    Args:
        employee_id (int): The ID whose TODO list progress is to be cheked.

    Returns:
        None: Prints the TODO list progress to the standard output.
    """
